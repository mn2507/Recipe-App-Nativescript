...
export class LoginComponent implements OnInit {
  ...
  login() {
    if (getConnectionType() === connectionType.none) {
      alert("Recipes requires an internet connection to log in.");
      return;
    }
  ...
  signUp() {
    if (getConnectionType() === connectionType.none) {
      alert("Recipes requires an internet connection to register.");
      return;
    }
  ...
  forgotPassword() {
    prompt({
      ...
      message: "Enter the email address you used to register for Recipes to reset your password.",
      defaultText: "",
      okButtonText: "Ok",
